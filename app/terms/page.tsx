  ...
  return (
    <div className="space-y-6 text-[15px] leading-relaxed">
      ...
      <section className="space-y-3">
        ...
        <p>
          {SITE_NAME}는 연말정산·종합소득세·부가가치세·증여세와 관련된 계산기와
          정보 콘텐츠를 무료로 제공하는 서비스입니다. 회원가입 없이 누구나 이용할
          수 있습니다.
        </p>
      </section>
      ...
      <section className="space-y-3">
        ...
        <p>
          본 사이트의 계산 결과와 콘텐츠는 공개된 세법·국세청 고시를 정리한
          <strong> 일반적인 참고 정보이며, 세무 자문이 아닙니다</strong>. 각
          계산기는 대표 항목만 반영한 간이 추정이며, 실제 세액은 소득·공제 항목,
          감면·할증, 개별 사정에 따라 달라집니다. 세율·공제 한도는 개정될 수
          있습니다.
        </p>
        <p>
          운영자는 정보의 정확성을 위해 노력하지만, 본 사이트의 정보를 근거로 한
          의사결정의 결과에 대해 법적 책임을 지지 않습니다. 정확한 신고·납부는
          국세청 홈택스와 세무 전문가를 통해 확인하시기 바랍니다.
        </p>
      </section>
