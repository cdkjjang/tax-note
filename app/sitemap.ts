...
export default function sitemap(): MetadataRoute.Sitemap {
  const staticPages: MetadataRoute.Sitemap = [
    ...
    { url: `${SITE_URL}/calc/year-end`, lastModified: TOOL_UPDATED, changeFrequency: "monthly", priority: 0.9 },
    { url: `${SITE_URL}/calc/income-tax`, lastModified: TOOL_UPDATED, changeFrequency: "monthly", priority: 0.9 },
    { url: `${SITE_URL}/calc/vat`, lastModified: TOOL_UPDATED, changeFrequency: "monthly", priority: 0.9 },
    { url: `${SITE_URL}/calc/gift-tax`, lastModified: TOOL_UPDATED, changeFrequency: "monthly", priority: 0.9 },
