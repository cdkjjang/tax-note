...
export const guides2: Guide[] = [
  {
    ...
    description:
      "배달, 유튜브·블로그, 스마트스토어, 중고거래 수익 중 어디까지가 신고 대상인지 정리했습니다. 연말정산과 5월 종합소득세로 어떻게 이어지는지, 회사에 알려질까 걱정되는 부분까지 담았습니다.",
    updated: "2026-09-13",
    intro: [
  ...
  },
  {
    ...
    description:
      "상속세는 어떤 재산에 붙고 공제는 어떻게 적용되는지, 배우자 상속공제와 일괄공제의 관계를 정리했습니다. 신고 기한 6개월과 연부연납, 상속세와 증여세 중 어느 쪽이 유리한지 판단하는 기준도 담았습니다.",
    updated: "2026-07-30",
    intro: [
